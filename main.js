...
import { extractTxtValues } from "./txtParsing";
...
const handleUploadTxt = async () => {
  try {
    ...
    const txtValues = extractTxtValues(contents);
    gridSize = txtValues.gridSize;
    obstaclesCoords = txtValues.obstaclesCoords;
    instructions = txtValues.instructions;
    errorOnUpload = txtValues.errorOnUpload;
    const splittedRows = txtValues.splittedRows;
